  ...
  'glass-panel-strong sheet-content-animate fixed z-50 flex flex-col overflow-hidden border-[hsl(var(--glass-border))] p-0 shadow-[var(--shadow-dialog)] will-change-transform',
  {
    variants: {
      side: {
        ...
        right:
          'sheet-content-bottom inset-x-0 bottom-0 h-auto max-h-[88dvh] w-full rounded-t-[28px] lg:sheet-content-right lg:inset-y-0 lg:left-auto lg:right-0 lg:h-full lg:max-h-none lg:w-[min(92vw,560px)] lg:rounded-l-2xl lg:rounded-tr-none',
      },
    },
    defaultVariants: {
      side: 'bottom',
...
>(({ side, className, children, ...props }, ref) => (
  <DrawPortal>
    <DrawOverlay />
    <DialogPrimitive.Content ref={ref} className={cn(drawVariants({ side }), className)} {...props}>
