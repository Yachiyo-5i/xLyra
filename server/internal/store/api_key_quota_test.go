...
func TestAPIKeyQuotaExceeded(t *testing.T) {
	...
	limited := func(limit, used float64) APIKey {
		return APIKey{QuotaLimit: sql.NullFloat64{Float64: limit, Valid: true}, QuotaUsed: used}
	}
	...
	cases := []struct {
		...
		{"unlimited ignores usage", APIKey{QuotaUnlimited: true, QuotaLimit: sql.NullFloat64{Float64: 100, Valid: true}, QuotaUsed: 999}, false},
