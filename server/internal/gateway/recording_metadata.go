...
func streamFailureScope(endReason string) any {
	...
	case "downstream_client_cancelled", "downstream_stream_write_failed":
		return "downstream"
	case "upstream_stream_read_failed", "upstream_stream_parse_failed", "upstream_stream_incomplete", "upstream_stream_eof", "upstream_stream_empty", "upstream_stream_missing_body":
		return "upstream"
	default:
		return nil
	}
