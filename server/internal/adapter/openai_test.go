...
func TestOpenAICompatiblePricingEndpointTypesUseProviderRules(t *testing.T) {
	...
	cases := []struct {
		...
		{provider: "xiaomi", modelID: "mimo-v2.5-tts", want: []string{"openai", "openai-audio-speech"}},
		{provider: "xiaomi", modelID: "mimo-v2.5-tts-voicedesign", want: []string{"openai", "openai-audio-speech"}},
		{provider: "xiaomi", modelID: "mimo-v2.5-tts-voiceclone", want: []string{"openai", "openai-audio-speech"}},
	}
	for _, tc := range cases {
